...
class MobileFourScreen extends StatelessWidget {
  const MobileFourScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the mobileFiveScreen when the action is triggered.
  onTapBtnPhPlayFill(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.mobileFiveScreen);
  }
