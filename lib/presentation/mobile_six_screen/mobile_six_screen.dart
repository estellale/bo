...
class MobileSixScreen extends StatelessWidget {
  const MobileSixScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the mobileSevenScreen when the action is triggered.
  onTapBtnPhPlayFill(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.mobileSevenScreen);
  }

  /// Navigates to the mobileEightScreen when the action is triggered.
  onTapBtnPhFastForwardFill(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.mobileEightScreen);
  }
}
